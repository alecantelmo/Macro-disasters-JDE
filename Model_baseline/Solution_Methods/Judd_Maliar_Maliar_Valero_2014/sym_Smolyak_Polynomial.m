...
% Change made by Oren Levintal on February 1, 2016: output is a symbolic variable. See line no. 73 
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
 ...
 function Smol_bases = sym_Smolyak_Polynomial(points,d,mu,Smol_elem)
...
phi = sym(ones(numb_pts,d,m_i_max)); 
